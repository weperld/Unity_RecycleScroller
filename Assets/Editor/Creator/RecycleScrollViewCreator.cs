...
public class RecycleScrollViewCreator : MonoBehaviour
{
    ...
    static void CreateRecycleScrollView(MenuCommand menuCommand)
        => Create(menuCommand, "Recycle_Scroll_View.prefab", "Recycle Scroll View");
    
    [MenuItem(MENU_PATH + "Loop Scrollbar (Vertical)", false)]
    static void CreateLoopScrollbarVertical(MenuCommand menuCommand)
    ...
    static void CreateLoopScrollbarHorizontal(MenuCommand menuCommand)
        => Create(menuCommand, "Loop_Scrollbar_Horizontal.prefab", "Loop Scrollbar Horizontal");
    
    
    static GameObject FindOrCreateCanvas_ReturnParent(GameObject selectedObj)
    {
        Canvas canvas = null;
    ...
    static void Create(MenuCommand menuCommand, string prefabName, string instanceName)
    {
